...
public class RequestParameterAuthenticationFilter extends AbstractPreAuthenticatedProcessingFilter {
    ...
    /**
     * Read and returns the header named by {@code principalRequestParameter}
     * from the request.
     *
     ...
     * {@code credentialsRequestParameter} is set, this will be read and used as
    ...
    public void setPrincipalRequestParameter(String principalRequestParameter) {
        Assert.hasText(principalRequestParameter, "principalRequestHeader must not be empty or null");
