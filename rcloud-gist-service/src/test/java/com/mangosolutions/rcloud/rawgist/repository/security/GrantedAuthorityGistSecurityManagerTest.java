...
public class GrantedAuthorityGistSecurityManagerTest {
    ...
    public void anonymousUserWithCollaborationAuthorityShouldNotHaveWriteAccess() {
        CollaborationGrantedAuthority collaboratorGrantedAuthority = new CollaborationGrantedAuthority(
                new String[] { OWNER_NAME });
        Collection<GrantedAuthority> authorities = Arrays.asList(collaboratorGrantedAuthority,
                AnonymousUserAuthorityResolver.ANONYMOUS_AUTHORITY);
    ...
    private UserDetails createUserDetails(String name) {
        Collection<GrantedAuthority> authorities = Arrays.asList(UserAuthorityResolver.USER_AUTHORITY,
                AnonymousUserAuthorityResolver.ANONYMOUS_AUTHORITY);
