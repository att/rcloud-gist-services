...
/**
 * Command that adds contents to a bare repository. This is based upon the JGit
 * AddCommand
 *
 */
public class BareAddCommand extends GitCommand<DirCache> {
     ...
     * 
     * @param f
     *            the iterator for the working tree
     * @return {@code this}
     */
    ...
    public DirCache call() throws GitAPIException {
        ...
        try (ObjectInserter inserter = repo.newObjectInserter();
            ...
            while (tw.next()) {
                ...
                if (entry != null && entry.getStage() > 0 && lastAdded != null && lastAdded.length == tw.getPathLength()
